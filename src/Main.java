public class Main {
    public static void main(String[] args) {
        ...
        if ( ageChild<5) {
            ...
            System.out.pr intln("Если ребенку " + ageChild + ", то он может кататься без сопровождения взрослого.");
        }
